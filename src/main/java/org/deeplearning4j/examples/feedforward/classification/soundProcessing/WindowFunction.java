package org.deeplearning4j.examples.feedforward.classification.soundProcessing;/*
...
/**
 * Base implementation for the org.deeplearning4j.examples.feedforward.classification.soundProcessing.WindowFunction types
 *
...
public abstract class WindowFunction {
    ...
    /**
     * Constructor of a org.deeplearning4j.examples.feedforward.classification.soundProcessing.WindowFunction
     * <p>
    ...
    public void applyFunction(double[] window) {
        if (window.length == this.windowSize) {
            ...
            throw new IllegalArgumentException("Incompatible window size for this org.deeplearning4j.examples.feedforward.classification.soundProcessing.WindowFunction instance : " +
